...
public class CourseController {
    ...
    private final GradebookServiceProxy gradebookServiceProxy;
    ...
    CourseController(GradebookServiceProxy gradebookServiceProxy) {
        this.gradebookServiceProxy = gradebookServiceProxy;
    }
